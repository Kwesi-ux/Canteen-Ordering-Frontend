  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (currentState === 'Sign Up') {
        const response = await fetch('https://canteen-ordering-system-huye.onrender.com/signup', {
          method: 'POST',
        ...
        const response = await fetch('https://canteen-ordering-system-huye.onrender.com/login', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
